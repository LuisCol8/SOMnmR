...
int_nmr <- function(raw.spec, NMRmeth=NULL) {
  ...
  if (is.null(NMRmeth)) {
    ...
    for (i in 1:length(raw.spec)) {
      ...
      Int1 <- data.frame(Int.x.1,Int.y.1)
      Int_model <- function (Int.x.1) {(Int.y.1)}
      Integral <- append(Integral,simp(Int_model, -145,-130, m = 0))
      ...
      Int2 <- data.frame(Int.x.2,Int.y.2)
      Int_model <- function (Int.x.2) {(Int.y.2)}
      Integral <- append(Integral,simp(f = Int_model, -130,-110, m = 50))
      ...
      Int3 <- data.frame(Int.x.3,Int.y.3)
      Int_model <- function (Int.x.3) {(Int.y.3)}
      Integral <- append(Integral,simp(f = Int_model, -110,-90, m = 50))
      ...
      Int4 <- data.frame(Int.x.4,Int.y.4)
      Int_model <- function (Int.x.4) {(Int.y.4)}
      Integral <- append(Integral,simp(f = Int_model, -90,-86, m = 50))
      ...
      Int5 <- data.frame(Int.x.5,Int.y.5)
      Int_model <- function (Int.x.5) {(Int.y.5)}
      Integral <- append(Integral,simp(f = Int_model, -86,-75, m = 50))
      ...
      Int6 <- data.frame(Int.x.6,Int.y.6)
      Int_model <- function (Int.x.6) {(Int.y.6)}
      Integral <- append(Integral,simp(f = Int_model, -75,-50, m = 50))
      ...
      Int7 <- data.frame(Int.x.7,Int.y.7)
      Int_model <- function (Int.x.7) {(Int.y.7)}
      Integral <- append(Integral,simp(f = Int_model, -50,-45, m = 50))
      ...
      Int8 <- data.frame(Int.x.8,Int.y.8)
      Int_model <- function (Int.x.8) {(Int.y.8)}
      Integral <- append(Integral,simp(f = Int_model, -45,-25, m = 50))
      ...
      Int9 <- data.frame(Int.x.9,Int.y.9)
      Int_model <- function (Int.x.9) {(Int.y.9)}
      Integral <- append(Integral,simp(f = Int_model, -25,-10, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.10 <- which(abs(spectrum[[c("ppm")]]-(-10)) == min(abs(spectrum[[c("ppm")]]-(-10))))
      Int.max.10 <- which(abs(spectrum[[c("ppm")]]-(0)) == min(abs(spectrum[[c("ppm")]]-(0))))
      Int.x.10 <- c(spectrum[[c("ppm")]][(Int.min.10:Int.max.10)])
      Int.y.10 <- c(spectrum[[c("raw.intensity")]][(Int.min.10:Int.max.10)])
      Int10 <- data.frame(Int.x.10,Int.y.10)
      Int_model <- function (Int.x.10) {(Int.y.10)}
      Integral <- append(Integral,simp(f = Int_model, -10,0, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.11 <- which(abs(spectrum[[c("ppm")]]-(0)) == min(abs(spectrum[[c("ppm")]]-(0))))
      Int.max.11 <- which(abs(spectrum[[c("ppm")]]-(5)) == min(abs(spectrum[[c("ppm")]]-(5))))
      Int.x.11 <- c(spectrum[[c("ppm")]][(Int.min.11:Int.max.11)])
      Int.y.11 <- c(spectrum[[c("raw.intensity")]][(Int.min.11:Int.max.11)])
      Int11 <- data.frame(Int.x.11,Int.y.11)
      Int_model <- function (Int.x.11) {(Int.y.11)}
      Integral <- append(Integral,simp(f = Int_model, 0,5, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.12 <- which(abs(spectrum[[c("ppm")]]-(5)) == min(abs(spectrum[[c("ppm")]]-(5))))
      Int.max.12 <- which(abs(spectrum[[c("ppm")]]-(25)) == min(abs(spectrum[[c("ppm")]]-(25))))
      Int.x.12 <- c(spectrum[[c("ppm")]][(Int.min.12:Int.max.12)])
      Int.y.12 <- c(spectrum[[c("raw.intensity")]][(Int.min.12:Int.max.12)])
      Int12 <- data.frame(Int.x.12,Int.y.12)
      Int_model <- function (Int.x.12) {(Int.y.12)}
      Integral <- append(Integral,simp(f = Int_model, 5,25, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.13 <- which(abs(spectrum[[c("ppm")]]-(25)) == min(abs(spectrum[[c("ppm")]]-(25))))
      Int.max.13 <- which(abs(spectrum[[c("ppm")]]-(45)) == min(abs(spectrum[[c("ppm")]]-(45))))
      Int.x.13 <- c(spectrum[[c("ppm")]][(Int.min.13:Int.max.13)])
      Int.y.13 <- c(spectrum[[c("raw.intensity")]][(Int.min.13:Int.max.13)])
      Int13 <- data.frame(Int.x.13,Int.y.13)
      Int_model <- function (Int.x.13) {(Int.y.13)}
      Integral <- append(Integral,simp(f = Int_model, 25,45, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.14 <- which(abs(spectrum[[c("ppm")]]-(45)) == min(abs(spectrum[[c("ppm")]]-(45))))
      Int.max.14 <- which(abs(spectrum[[c("ppm")]]-(49)) == min(abs(spectrum[[c("ppm")]]-(49))))
      Int.x.14 <- c(spectrum[[c("ppm")]][(Int.min.14:Int.max.14)])
      Int.y.14 <- c(spectrum[[c("raw.intensity")]][(Int.min.14:Int.max.14)])
      Int14 <- data.frame(Int.x.14,Int.y.14)
      Int_model <- function (Int.x.14) {(Int.y.14)}
      Integral <- append(Integral,simp(f = Int_model, 45,49, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.15 <- which(abs(spectrum[[c("ppm")]]-(49)) == min(abs(spectrum[[c("ppm")]]-(49))))
      Int.max.15 <- which(abs(spectrum[[c("ppm")]]-(60)) == min(abs(spectrum[[c("ppm")]]-(60))))
      Int.x.15 <- c(spectrum[[c("ppm")]][(Int.min.15:Int.max.15)])
      Int.y.15 <- c(spectrum[[c("raw.intensity")]][(Int.min.15:Int.max.15)])
      Int15 <- data.frame(Int.x.15,Int.y.15)
      Int_model <- function (Int.x.15) {(Int.y.15)}
      Integral <- append(Integral,simp(f = Int_model, 49,60, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.16 <- which(abs(spectrum[[c("ppm")]]-(60)) == min(abs(spectrum[[c("ppm")]]-(60))))
      Int.max.16 <- which(abs(spectrum[[c("ppm")]]-(85)) == min(abs(spectrum[[c("ppm")]]-(85))))
      Int.x.16 <- c(spectrum[[c("ppm")]][(Int.min.16:Int.max.16)])
      Int.y.16 <- c(spectrum[[c("raw.intensity")]][(Int.min.16:Int.max.16)])
      Int16 <- data.frame(Int.x.16,Int.y.16)
      Int_model <- function (Int.x.16) {(Int.y.16)}
      Integral <- append(Integral,simp(f = Int_model, 60,85, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.17 <- which(abs(spectrum[[c("ppm")]]-(85)) == min(abs(spectrum[[c("ppm")]]-(85))))
      Int.max.17 <- which(abs(spectrum[[c("ppm")]]-(95)) == min(abs(spectrum[[c("ppm")]]-(95))))
      Int.x.17 <- c(spectrum[[c("ppm")]][(Int.min.17:Int.max.17)])
      Int.y.17 <- c(spectrum[[c("raw.intensity")]][(Int.min.17:Int.max.17)])
      Int17 <- data.frame(Int.x.17,Int.y.17)
      Int_model <- function (Int.x.17) {(Int.y.17)}
      Integral <- append(Integral,simp(f = Int_model, 85,95, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.18 <- which(abs(spectrum[[c("ppm")]]-(95)) == min(abs(spectrum[[c("ppm")]]-(95))))
      Int.max.18 <- which(abs(spectrum[[c("ppm")]]-(110)) == min(abs(spectrum[[c("ppm")]]-(110))))
      Int.x.18 <- c(spectrum[[c("ppm")]][(Int.min.18:Int.max.18)])
      Int.y.18 <- c(spectrum[[c("raw.intensity")]][(Int.min.18:Int.max.18)])
      Int18 <- data.frame(Int.x.18,Int.y.18)
      Int_model <- function (Int.x.18) {(Int.y.18)}
      Integral <- append(Integral,simp(f = Int_model, 95,110, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.19 <- which(abs(spectrum[[c("ppm")]]-(110)) == min(abs(spectrum[[c("ppm")]]-(110))))
      Int.max.19 <- which(abs(spectrum[[c("ppm")]]-(125)) == min(abs(spectrum[[c("ppm")]]-(125))))
      Int.x.19 <- c(spectrum[[c("ppm")]][(Int.min.19:Int.max.19)])
      Int.y.19 <- c(spectrum[[c("raw.intensity")]][(Int.min.19:Int.max.19)])
      Int19 <- data.frame(Int.x.19,Int.y.19)
      Int_model <- function (Int.x.19) {(Int.y.19)}
      Integral <- append(Integral,simp(f = Int_model, 110,125, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.20 <- which(abs(spectrum[[c("ppm")]]-(125)) == min(abs(spectrum[[c("ppm")]]-(125))))
      Int.max.20 <- which(abs(spectrum[[c("ppm")]]-(145)) == min(abs(spectrum[[c("ppm")]]-(145))))
      Int.x.20 <- c(spectrum[[c("ppm")]][(Int.min.20:Int.max.20)])
      Int.y.20 <- c(spectrum[[c("raw.intensity")]][(Int.min.20:Int.max.20)])
      Int20 <- data.frame(Int.x.20,Int.y.20)
      Int_model <- function (Int.x.20) {(Int.y.20)}
      Integral <- append(Integral,simp(f = Int_model, 125,145, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.21 <- which(abs(spectrum[[c("ppm")]]-(145)) == min(abs(spectrum[[c("ppm")]]-(145))))
      Int.max.21 <- which(abs(spectrum[[c("ppm")]]-(165)) == min(abs(spectrum[[c("ppm")]]-(165))))
      Int.x.21 <- c(spectrum[[c("ppm")]][(Int.min.21:Int.max.21)])
      Int.y.21 <- c(spectrum[[c("raw.intensity")]][(Int.min.21:Int.max.21)])
      Int21 <- data.frame(Int.x.21,Int.y.21)
      Int_model <- function (Int.x.21) {(Int.y.21)}
      Integral <- append(Integral,simp(f = Int_model, 145, 165, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.22 <- which(abs(spectrum[[c("ppm")]]-(165)) == min(abs(spectrum[[c("ppm")]]-(165))))
      Int.max.22 <- which(abs(spectrum[[c("ppm")]]-(180)) == min(abs(spectrum[[c("ppm")]]-(180))))
      Int.x.22 <- c(spectrum[[c("ppm")]][(Int.min.22:Int.max.22)])
      Int.y.22<- c(spectrum[[c("raw.intensity")]][(Int.min.22:Int.max.22)])
      Int22 <- data.frame(Int.x.22,Int.y.22)
      Int_model <- function (Int.x.22) {(Int.y.22)}
      Integral <- append(Integral,simp(f = Int_model, 165,180, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.23 <- which(abs(spectrum[[c("ppm")]]-(180)) == min(abs(spectrum[[c("ppm")]]-(180))))
      Int.max.23 <- which(abs(spectrum[[c("ppm")]]-(185)) == min(abs(spectrum[[c("ppm")]]-(185))))
      Int.x.23 <- c(spectrum[[c("ppm")]][(Int.min.23:Int.max.23)])
      Int.y.23 <- c(spectrum[[c("raw.intensity")]][(Int.min.23:Int.max.23)])
      Int23 <- data.frame(Int.x.23,Int.y.23)
      Int_model <- function (Int.x.23) {(Int.y.23)}
      Integral <- append(Integral,simp(f = Int_model, 180,185, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.24 <- which(abs(spectrum[[c("ppm")]]-(185)) == min(abs(spectrum[[c("ppm")]]-(185))))
      Int.max.24 <- which(abs(spectrum[[c("ppm")]]-(195)) == min(abs(spectrum[[c("ppm")]]-(195))))
      Int.x.24 <- c(spectrum[[c("ppm")]][(Int.min.24:Int.max.24)])
      Int.y.24 <- c(spectrum[[c("raw.intensity")]][(Int.min.24:Int.max.24)])
      Int24 <- data.frame(Int.x.24,Int.y.24)
      Int_model <- function (Int.x.24) {(Int.y.24)}
      Integral <- append(Integral,simp(f = Int_model, 185,195, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.25 <- which(abs(spectrum[[c("ppm")]]-(195)) == min(abs(spectrum[[c("ppm")]]-(195))))
      Int.max.25 <- which(abs(spectrum[[c("ppm")]]-(215)) == min(abs(spectrum[[c("ppm")]]-(215))))
      Int.x.25 <- c(spectrum[[c("ppm")]][(Int.min.25:Int.max.25)])
      Int.y.25 <- c(spectrum[[c("raw.intensity")]][(Int.min.25:Int.max.25)])
      Int25 <- data.frame(Int.x.25,Int.y.25)
      Int_model <- function (Int.x.25) {(Int.y.25)}
      Integral <- append(Integral,simp(f = Int_model, 195,215, m = 10))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.26 <- which(abs(spectrum[[c("ppm")]]-(215)) == min(abs(spectrum[[c("ppm")]]-(215))))
      Int.max.26 <- which(abs(spectrum[[c("ppm")]]-(225)) == min(abs(spectrum[[c("ppm")]]-(225))))
      Int.x.26 <- c(spectrum[[c("ppm")]][(Int.min.26:Int.max.26)])
      Int.y.26 <- c(spectrum[[c("raw.intensity")]][(Int.min.26:Int.max.26)])
      Int26 <- data.frame(Int.x.26,Int.y.26)
      Int_model <- function (Int.x.26) {(Int.y.26)}
      Integral <- append(Integral,simp(f = Int_model, 215,225, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.27 <- which(abs(spectrum[[c("ppm")]]-(225)) == min(abs(spectrum[[c("ppm")]]-(225))))
      Int.max.27 <- which(abs(spectrum[[c("ppm")]]-(245)) == min(abs(spectrum[[c("ppm")]]-(245))))
      Int.x.27 <- c(spectrum[[c("ppm")]][(Int.min.27:Int.max.27)])
      Int.y.27 <- c(spectrum[[c("raw.intensity")]][(Int.min.27:Int.max.27)])
      Int27 <- data.frame(Int.x.27,Int.y.27)
      Int_model <- function (Int.x.27) {(Int.y.27)}
      Integral <- append(Integral,simp(f = Int_model, 225,245, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.28 <- which(abs(spectrum[[c("ppm")]]-(245)) == min(abs(spectrum[[c("ppm")]]-(245))))
      Int.max.28 <- which(abs(spectrum[[c("ppm")]]-(260)) == min(abs(spectrum[[c("ppm")]]-(260))))
      Int.x.28 <- c(spectrum[[c("ppm")]][(Int.min.28:Int.max.28)])
      Int.y.28 <- c(spectrum[[c("raw.intensity")]][(Int.min.28:Int.max.28)])
      Int28 <- data.frame(Int.x.28,Int.y.28)
      Int_model <- function (Int.x.28) {(Int.y.28)}
      Integral <- append(Integral,simp(f = Int_model, 245,260, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.29 <- which(abs(spectrum[[c("ppm")]]-(260)) == min(abs(spectrum[[c("ppm")]]-(260))))
      Int.max.29 <- which(abs(spectrum[[c("ppm")]]-(275)) == min(abs(spectrum[[c("ppm")]]-(275))))
      Int.x.29 <- c(spectrum[[c("ppm")]][(Int.min.29:Int.max.29)])
      Int.y.29 <- c(spectrum[[c("raw.intensity")]][(Int.min.29:Int.max.29)])
      Int29 <- data.frame(Int.x.29,Int.y.29)
      Int_model <- function (Int.x.29) {(Int.y.29)}
      Integral <- append(Integral,simp(f = Int_model, 260,275, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.30 <- which(abs(spectrum[[c("ppm")]]-(275)) == min(abs(spectrum[[c("ppm")]]-(275))))
      Int.max.30 <- which(abs(spectrum[[c("ppm")]]-(295)) == min(abs(spectrum[[c("ppm")]]-(295))))
      Int.x.30 <- c(spectrum[[c("ppm")]][(Int.min.30:Int.max.30)])
      Int.y.30 <- c(spectrum[[c("raw.intensity")]][(Int.min.30:Int.max.30)])
      Int30 <- data.frame(Int.x.30,Int.y.30)
      Int_model <- function (Int.x.30) {(Int.y.30)}
      Integral <- append(Integral,simp(f = Int_model, 275,295, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.31 <- which(abs(spectrum[[c("ppm")]]-(295)) == min(abs(spectrum[[c("ppm")]]-(295))))
      Int.max.31 <- which(abs(spectrum[[c("ppm")]]-(315)) == min(abs(spectrum[[c("ppm")]]-(315))))
      Int.x.31 <- c(spectrum[[c("ppm")]][(Int.min.31:Int.max.31)])
      Int.y.31 <- c(spectrum[[c("raw.intensity")]][(Int.min.31:Int.max.31)])
      Int31 <- data.frame(Int.x.31,Int.y.31)
      Int_model <- function (Int.x.31) {(Int.y.31)}
      Integral <- append(Integral,simp(f = Int_model, 295,315, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.32 <- which(abs(spectrum[[c("ppm")]]-(315)) == min(abs(spectrum[[c("ppm")]]-(315))))
      Int.max.32 <- which(abs(spectrum[[c("ppm")]]-(320)) == min(abs(spectrum[[c("ppm")]]-(320))))
      Int.x.32 <- c(spectrum[[c("ppm")]][(Int.min.32:Int.max.32)])
      Int.y.32 <- c(spectrum[[c("raw.intensity")]][(Int.min.32:Int.max.32)])
      Int32 <- data.frame(Int.x.32,Int.y.32)
      Int_model <- function (Int.x.32) {(Int.y.32)}
      Integral <- append(Integral,simp(f = Int_model, 315,320, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.33 <- which(abs(spectrum[[c("ppm")]]-(320)) == min(abs(spectrum[[c("ppm")]]-(320))))
      Int.max.33 <- which(abs(spectrum[[c("ppm")]]-(330)) == min(abs(spectrum[[c("ppm")]]-(330))))
      Int.x.33 <- c(spectrum[[c("ppm")]][(Int.min.33:Int.max.33)])
      Int.y.33 <- c(spectrum[[c("raw.intensity")]][(Int.min.33:Int.max.33)])
      Int33 <- data.frame(Int.x.33,Int.y.33)
      Int_model <- function (Int.x.33) {(Int.y.33)}
      Integral <- append(Integral,simp(f = Int_model, 320,330, m = 50))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.34 <- which(abs(spectrum[[c("ppm")]]-(330)) == min(abs(spectrum[[c("ppm")]]-(330))))
      Int.max.34 <- which(abs(spectrum[[c("ppm")]]-(355)) == min(abs(spectrum[[c("ppm")]]-(355))))
      Int.x.34 <- c(spectrum[[c("ppm")]][(Int.min.34:Int.max.34)])
      Int.y.34 <- c(spectrum[[c("raw.intensity")]][(Int.min.34:Int.max.34)])
      Int34 <- data.frame(Int.x.34,Int.y.34)
      Int_model <- function (Int.x.34) {(Int.y.34)}
      Integral <- append(Integral,simp(f = Int_model, 330,355, m = 50))

      norm <- sum(Integral[1:34])
      normalized.Int <- (Integral/norm)*100
      Integral <- data.frame(normalized.Int)
      raw.spec.end[[i]] <- list("name" = name, "data" = list("raw.spec" = spectrum,"Integral" = Integral))
      }
