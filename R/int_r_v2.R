...
int_nmr2 <- function(raw.spec, NMRmeth=NULL, SSBcorr=FALSE) {
  ...
  if (is.null(NMRmeth)) {
    ...
    for (i in 1:length(raw.spec)) {
      ...
      Int.min.1 <- which(abs(spectrum[[c("ppm")]]-(-110)) == min(abs(spectrum[[c("ppm")]]-(-110))))
      Int.max.1 <- which(abs(spectrum[[c("ppm")]]-(-95)) == min(abs(spectrum[[c("ppm")]]-(-95))))
      ...
      Integral <- append(Integral,trap(Int_model, -110,-95, m = 240))
      #print(length((Int.x.1)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.2 <- which(abs(spectrum[[c("ppm")]]-(-95)) == min(abs(spectrum[[c("ppm")]]-(-95))))
      Int.max.2 <- which(abs(spectrum[[c("ppm")]]-(-75)) == min(abs(spectrum[[c("ppm")]]-(-75))))
      ...
      Integral <- append(Integral,trap(f = Int_model, -95,-75, m = 300))
      #print(length((Int.x.2)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.3 <- which(abs(spectrum[[c("ppm")]]-(-75)) == min(abs(spectrum[[c("ppm")]]-(-75))))
      Int.max.3 <- which(abs(spectrum[[c("ppm")]]-(-55)) == min(abs(spectrum[[c("ppm")]]-(-55))))
      ...
      Integral <- append(Integral,trap(f = Int_model, -75,-55, m = 300))
      #print(length((Int.x.3)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.4 <- which(abs(spectrum[[c("ppm")]]-(-55)) == min(abs(spectrum[[c("ppm")]]-(-55))))
      Int.max.4 <- which(abs(spectrum[[c("ppm")]]-(-51)) == min(abs(spectrum[[c("ppm")]]-(-51))))
      ...
      Integral <- append(Integral,trap(f = Int_model, -55,-51, m = 66))
      #print(length((Int.x.4)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.5 <- which(abs(spectrum[[c("ppm")]]-(-51)) == min(abs(spectrum[[c("ppm")]]-(-51))))
      Int.max.5 <- which(abs(spectrum[[c("ppm")]]-(-40)) == min(abs(spectrum[[c("ppm")]]-(-40))))
      ...
      Integral <- append(Integral,trap(f = Int_model, -51,-40, m = 180))
      #print(length((Int.x.5)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.6 <- which(abs(spectrum[[c("ppm")]]-(-40)) == min(abs(spectrum[[c("ppm")]]-(-40))))
      Int.max.6 <- which(abs(spectrum[[c("ppm")]]-(-15)) == min(abs(spectrum[[c("ppm")]]-(-15))))
      ...
      Integral <- append(Integral,trap(f = Int_model, -40,-15, m = 400))
      #print(length((Int.x.6)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.7 <- which(abs(spectrum[[c("ppm")]]-(-15)) == min(abs(spectrum[[c("ppm")]]-(-15))))
      Int.max.7 <- which(abs(spectrum[[c("ppm")]]-(-10)) == min(abs(spectrum[[c("ppm")]]-(-10))))
      ...
      Integral <- append(Integral,trap(f = Int_model, -15,-10, m = 80))
      #print(length((Int.x.7)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.8 <- which(abs(spectrum[[c("ppm")]]-(-10)) == min(abs(spectrum[[c("ppm")]]-(-10))))
      Int.max.8 <- which(abs(spectrum[[c("ppm")]]-(5)) == min(abs(spectrum[[c("ppm")]]-(5))))
      ...
      Integral <- append(Integral,trap(f = Int_model, -10,5, m = 300))
      #print(length((Int.x.8)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.9 <- which(abs(spectrum[[c("ppm")]]-(5)) == min(abs(spectrum[[c("ppm")]]-(5))))
      Int.max.9 <- which(abs(spectrum[[c("ppm")]]-(25)) == min(abs(spectrum[[c("ppm")]]-(25))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 5, 25, m = 240))
      #print(length((Int.x.9)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.10 <- which(abs(spectrum[[c("ppm")]]-(25)) == min(abs(spectrum[[c("ppm")]]-(25))))
      Int.max.10 <- which(abs(spectrum[[c("ppm")]]-(45)) == min(abs(spectrum[[c("ppm")]]-(45))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 25,45, m = 240))
      #print(length((Int.x.10)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.11 <- which(abs(spectrum[[c("ppm")]]-(45)) == min(abs(spectrum[[c("ppm")]]-(45))))
      Int.max.11 <- which(abs(spectrum[[c("ppm")]]-(49)) == min(abs(spectrum[[c("ppm")]]-(49))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 45,49, m = 300))
      #print(length((Int.x.11)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.12 <- which(abs(spectrum[[c("ppm")]]-(49)) == min(abs(spectrum[[c("ppm")]]-(49))))
      Int.max.12 <- which(abs(spectrum[[c("ppm")]]-(60)) == min(abs(spectrum[[c("ppm")]]-(60))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 49,60, m = 300))
      #print(length((Int.x.12)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.13 <- which(abs(spectrum[[c("ppm")]]-(60)) == min(abs(spectrum[[c("ppm")]]-(60))))
      Int.max.13 <- which(abs(spectrum[[c("ppm")]]-(85)) == min(abs(spectrum[[c("ppm")]]-(85))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 60,85, m = 66))
      #print(length((Int.x.13)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.14 <- which(abs(spectrum[[c("ppm")]]-(85)) == min(abs(spectrum[[c("ppm")]]-(85))))
      Int.max.14 <- which(abs(spectrum[[c("ppm")]]-(90)) == min(abs(spectrum[[c("ppm")]]-(90))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 85,90, m = 180))
      #print(length((Int.x.14)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.15 <- which(abs(spectrum[[c("ppm")]]-(90)) == min(abs(spectrum[[c("ppm")]]-(90))))
      Int.max.15 <- which(abs(spectrum[[c("ppm")]]-(110)) == min(abs(spectrum[[c("ppm")]]-(110))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 90,110, m = 400))
      #print(length((Int.x.15)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.16 <- which(abs(spectrum[[c("ppm")]]-(110)) == min(abs(spectrum[[c("ppm")]]-(110))))
      Int.max.16 <- which(abs(spectrum[[c("ppm")]]-(125)) == min(abs(spectrum[[c("ppm")]]-(125))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 110,125, m = 80))
      #print(length((Int.x.16)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.17 <- which(abs(spectrum[[c("ppm")]]-(125)) == min(abs(spectrum[[c("ppm")]]-(125))))
      Int.max.17 <- which(abs(spectrum[[c("ppm")]]-(140)) == min(abs(spectrum[[c("ppm")]]-(140))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 125,140, m = 300))
      #print(length((Int.x.17)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.18 <- which(abs(spectrum[[c("ppm")]]-(140)) == min(abs(spectrum[[c("ppm")]]-(140))))
      Int.max.18 <- which(abs(spectrum[[c("ppm")]]-(160)) == min(abs(spectrum[[c("ppm")]]-(160))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 140,160, m = 240))
      #print(length((Int.x.18)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.19 <- which(abs(spectrum[[c("ppm")]]-(160)) == min(abs(spectrum[[c("ppm")]]-(160))))
      Int.max.19 <- which(abs(spectrum[[c("ppm")]]-(180)) == min(abs(spectrum[[c("ppm")]]-(180))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 160,180, m = 240))
      #print(length((Int.x.19)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.20 <- which(abs(spectrum[[c("ppm")]]-(180)) == min(abs(spectrum[[c("ppm")]]-(180))))
      Int.max.20 <- which(abs(spectrum[[c("ppm")]]-(185)) == min(abs(spectrum[[c("ppm")]]-(185))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 180,185, m = 300))
      #print(length((Int.x.20)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.21 <- which(abs(spectrum[[c("ppm")]]-(185)) == min(abs(spectrum[[c("ppm")]]-(185))))
      Int.max.21 <- which(abs(spectrum[[c("ppm")]]-(195)) == min(abs(spectrum[[c("ppm")]]-(195))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 185, 195, m = 300))
      #print(length((Int.x.21)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.22 <- which(abs(spectrum[[c("ppm")]]-(195)) == min(abs(spectrum[[c("ppm")]]-(195))))
      Int.max.22 <- which(abs(spectrum[[c("ppm")]]-(220)) == min(abs(spectrum[[c("ppm")]]-(220))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 195,220, m = 80))
      #print(length((Int.x.22)))

      ## Extract ppm (x) and the intesity (y) for predifined intervals
      Int.min.23 <- which(abs(spectrum[[c("ppm")]]-(220)) == min(abs(spectrum[[c("ppm")]]-(220))))
      ...
      Integral <- append(Integral,trap(f = Int_model, 220,195, m = 160))
    ...
    for (i in 1:length(raw.spec)) {
      ...
      if (SSBcorr == TRUE) {
        ...
        Alkyl <-  setNames(data.frame(sum(2*sum(Integral[30:33]), sum(Integral[21:24]), -sum(Integral[3:6]))), c("Alkyl"))
        
        ##N_Alkyl_Methoxyl C calculation
        N_Alkyl_Methoxyl <-  setNames(data.frame(sum(2*sum(Integral[27:29]), sum(Integral[18:20]), -sum(Integral[1:2]))), c("N_Alkyl_Methoxyl"))
        
        ##O-Alkyl C calculation
        O_Alkyl <-  setNames(data.frame(sum(2*sum(Integral[4:8]), sum(Integral[13:17]), -sum(Integral[31:33]))), c("O-Alkyl"))
        
        ##Di_O_Alkyl C calculation
        Di_O_Alkyl <-  setNames(data.frame(sum(2*sum(Integral[1:3]), sum(Integral[10:12]), -sum(Integral[28:30]))), c("Di_O_Alkyl"))
        
        ##Aromatic C calculation
        Aromatic <-  setNames(data.frame(sum(2*sum(Integral[6:7]), sum(Integral[15:16]), -sum(Integral[33:33]))), c("Aromatic"))
        
        ##Phenolic C calculation
        Phenolic <-  setNames(data.frame(sum(2*sum(Integral[5:5]), sum(Integral[14:14]), -sum(Integral[32:32]))), c("Phenolic"))
        
        ##Amide_Carboxylic C calculation
        Amide_Carboxylic <-  setNames(data.frame(sum(2*sum(Integral[2:4]), sum(Integral[11:13]), -sum(Integral[29:31]))), c("Amide_Carboxylic"))
        
        ##Ketone C calculation
        Ketone <-  setNames(data.frame(sum(2*sum(Integral[1:1]), sum(Integral[10:1]), -sum(Integral[28:28]))), c("Ketone"))
